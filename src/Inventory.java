...
public class Inventory {
    ...
    public static void initData() {
        if (spacecrafts.size() < 12) {
            ...
            spacecrafts.add(new UnCrewedSpacecraft("Starlink satellite #1", LocalDate.parse("2019-05-24"), null, "krypton", 500, 0, 1, "comms service", 100, 0, 0, "E-band phased array antennas"));
            spacecrafts.add(new CrewedSpacecraft("SpaceX Dragon 2 #1", LocalDate.parse("2020-05-30"), null, " NTO / MMH propellant", 27600, 90, 8, "human-rated orbital transport", 100, 0, 4));
            ...
            spacecrafts.add(new UnCrewedSpacecraft("Starlink satellite #2", LocalDate.parse("2019-05-24"), null, "krypton", 500, 0, 1, "comms service", 100, 0, 0, "E-band phased array antennas"));
            spacecrafts.add(new CrewedSpacecraft("SpaceX Dragon 2 #2", LocalDate.parse("2021-11-12"), null, " NTO / MMH propellant", 27600, 90, 8, "human-rated orbital transport", 100, 0, 4));
            ...
            spacecrafts.add(new UnCrewedSpacecraft("Starlink satellite #3", LocalDate.parse("2019-05-24"), null, "krypton", 500, 0, 1, "comms service", 100, 0, 0, "E-band phased array antennas"));
            spacecrafts.add(new CrewedSpacecraft("SpaceX Dragon 2 #3", LocalDate.parse("2022-03-30"), null, " NTO / MMH propellant", 27600, 90, 8, "human-rated orbital transport", 100, 0, 4));
